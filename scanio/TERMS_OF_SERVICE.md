# Scanio Terms of Service

**Effective Date:** February 25, 2026

---

By downloading, installing, or using Scanio ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the App.

---

## 1. Description of Service

Scanio is a barcode and QR code utility application for iOS. The App provides the following features:

- Scan barcodes and QR codes using the device camera
- Generate QR codes and barcodes
- Save and manage scan history
- Connect to Wi-Fi networks via QR codes
...
- The App is free to download and use with advertisements displayed via Google AdMob.

### 2.2 Premium Subscription

- The App offers an optional subscription to unlock premium features and remove advertisements.
- Subscriptions are billed through Apple's App Store and are subject to [Apple's Terms and Conditions](https://www.apple.com/legal/internet-services/itunes/).
- Payment will be charged to your Apple ID account at confirmation of purchase.
- Subscriptions automatically renew unless canceled at least 24 hours before the end of the current billing period.
- You can manage or cancel your subscription at any time in your Apple ID account settings (Settings > Apple ID > Subscriptions).

### 2.3 Refunds

- Refund requests must be submitted directly to Apple. We do not process refunds.
...
- Scan or generate codes intended to deceive, defraud, or harm others
...
All content, design, graphics, and code within the App are the property of the developer and are protected by applicable intellectual property laws. You may not reproduce, distribute, or create derivative works without prior written consent.
...
- Scan results will be 100% accurate in all cases
- Generated codes will be compatible with all readers or devices
- Wi-Fi connections via QR codes will always succeed

---

## 6. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF DATA, PROFITS, OR GOODWILL, ARISING FROM:

- Your use of or inability to use the App
- Any errors or inaccuracies in scan results or generated codes
- Unauthorized access to data stored on your device
- Any third-party content accessed through scanned codes
...
We may update these Terms from time to time. Changes will be indicated by updating the "Effective Date" at the top of this page. Continued use of the App after changes are posted constitutes your acceptance of the updated Terms.
...
_These Terms of Service are effective as of February 25, 2026._
